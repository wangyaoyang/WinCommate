...
// 命令(ID_* 和 IDM_*) 
#define HID_SEND_VIEW_HEX                       0x18006
#define HID_SEND_VIEW_ASCII                     0x18007
#define HID_SEND_VIEW_CANCEL                    0x18009
#define HID_RECV_LIST_VIEW_CLEAR                0x1800B
#define HID_RECV_LIST_VIEW_SAVELOG              0x1800F
#define HID_SEND_VIEW_CYCLESEND                 0x18010
#define HID_RECV_LIST_VIEW_HEX                  0x18011
#define HID_SEND_VIEW_CHECKSUM                  0x18012
#define HID_SEND_VIEW_CHECKSUM2                 0x18013
#define HID_SEND_VIEW_CHECKCRC                  0x18014
#define HID_SEND_VIEW_TRANS_ASCII               0x18015
#define HID_SEND_VIEW_TRANS_HEX                 0x18016
#define HID_SEND_VIEW_CALCULATER                0x18017
#define HID_SEND_VIEW_ASCII_LINE                0x18018
#define HID_POPUP_EXEC_CLEAR                    0x18019
#define HID_POPUP_EXEC_EXECUTE                  0x1801A
#define HID_RECV_BUFF_DELETE                    0x1801B
#define HID_POPUP_EXEC_STOP                     0x1801C
#define HID_RECV_LIST_VIEW_REVIEW               0x1801D
#define HID_RECV_BUFF_REFRESH                   0x1801E
#define HID_POPUP_EXEC_SEL_ALL                  0x1801F
#define HID_SENDVIEW_SEL_ALL                    0x18020
#define HID_RECV_BUFF_ASCII_HEX                 0x18021
#define HID_SENDVIEW_CLEAR                      0x18022
#define HID_RECV_LIST_VIEW_OPENLOG              0x18023
#define HID_RECV_BUFF_FILTER_RECV               0x18024
#define HID_RECV_BUFF_FILTER_SEND               0x18025
#define HID_RECV_BUFF_FILTER_ALL                0x18026
#define HID_SEND_VIEW_TXT_LF                    0x18027
#define HID_SEND_VIEW_ECHO                      0x18028
#define HID_POPUP_EXEC_LOAD                     0x18029
#define HID_VIEW_RUNTIME                        0x1802A
#define HID_VIEW_SIGNAL                         0x1802B
#define HID_VIEW_COLOUR                         0x1802C
#define HID_SEND_VIEW_EDIT                      0x1802D
#define HID_RECV_LIST_VIEW_COLOR                0x1802E
#define HID_RECV_LIST_VIEW_SELECT_ALL           0x1802F
#define HID_RECV_LIST_VIEW_COPY                 0x18030
#define HID_VIEW_REFRESH                        0x18032
#define HID_VIEW_SHOWDATA                       0x18033
#define HID_RECV_LIST_VIEW_FILTER               0x18034
#define HID_POPUP_EXEC_DEBUG                    0x18035
#define HID_POPUP_EXEC_CLEAR_TRACE              0x18036
...
#define HIDR_ProbeTYPE                          0x20081
#define HIDR_TOOLBAR_INPUT                      0x20086
#define HIDR_MENU_RECV_BUFF                     0x2008E
 
// 对话框(IDD_*) 
#define HIDD_ABOUTBOX                           0x20064
#define HIDD_PORT_SETTING                       0x20083
#define HIDD_PORT_RECEIVED                      0x20084
#define HIDD_CALCULATE                          0x20085
#define HIDD_CONVERTION_DLG                     0x2008A
#define HIDD_TITLE_BAR                          0x2008B
#define HIDD_SEND_RECYCYLE                      0x2008C
#define HIDD_RECV_BUFF                          0x2008D
#define HIDD_DISPLAY                            0x2008F
#define HIDD_IP_FILTER                          0x20090
#define HIDD_DIALOG_ETH_SELECT                  0x20136
