...
#include <afxhtml.h>			// Windows 公共控件的 MFC 支持
#include <afxrich.h>			// Windows 公共控件的 MFC 支持
#endif // _AFX_NO_AFXCMN_SUPPORT

#define	XLISTCTRLLIB_STATIC 
#include ".\FloatBar\sizecbar.h"
#include ".\FloatBar\scbarg.h"
#include "XTrace.h"
#include "XListCtrl.h"
#include <afxcontrolbars.h>

#ifdef	UNICODE
#define	UNI_SCANF	swscanf_s
#else
#define	UNI_SCANF	sscanf_s
#endif	//UNICODE
